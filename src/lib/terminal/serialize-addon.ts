...
import type { IBufferRange, ITerminalAddon, ITerminalCore } from 'ghostty-web'
...
class StringSerializeHandler extends BaseSerializeHandler {
  ...
  constructor(buffer: IBuffer, terminal: ITerminalCore) {
    super(buffer)
...
export class SerializeAddon implements ITerminalAddon {
  ...
  public serialize(options?: ISerializeOptions): string {
    ...
    const terminal = this._terminal as unknown as {
      buffer?: { normal?: IBuffer; active?: IBuffer; alternate?: IBuffer }
    }
  ...
  public serializeAsText(options?: { scrollback?: number; trimWhitespace?: boolean }): string {
    ...
    const terminal = this._terminal as unknown as {
      buffer?: { active?: IBuffer; normal?: IBuffer }
    }
    const buffer = terminal.buffer
